...
export const PROP_SCHEMA = {
  ...
  icon: {
    ...
    control: "text",
    label: "Icon",
    description: "Font Awesome icon class (e.g. fa-solid fa-chart-simple)",
  },
  iconColor: {
    type: "string",
    default: "orange",
  ...
  iconHorizontalAlignment: {
    ...
    options: ["Start", "Center", "End"],
    label: "Horizontal Alignment",
    description: "Icon horizontal alignment",
  },
  iconAnimation: {
    type: "string",
    default: "",
  ...
  iconAnimationSpeed: {
    ...
    description: "Icon animation speed",
  },
  iconAnimationDirection: {
    ...
    description: "Icon animation direction",
  },
  backgroundColor: {
    type: "string",
    default: "",
