...
export const PROP_SCHEMA = {
  ...
  title: { type: 'string', default: 'Polar Area Chart', control: 'text', label: 'Title' },
  ...
  segmentBorderColor: { type: 'string', default: '#fff', control: 'colorPure', label: 'Segment Border Color' },
  fillCell: {
    type: 'boolean',
    default: true,
    control: 'switch',
...
export const CONFIGURABLE_PROPS_BY_GROUP = {
  ...
  chart: ['segmentBorderWidth', 'segmentBorderColor', 'fillCell', 'verticalAlignment', 'maintainAspectRatio', 'tooltipsEnabled'],
  card: [
    'backgroundColor',
    'borderLeftColor',
    'borderTopColor',
...
export function buildPropertySchema(props = {}) {
  const displayLabel = props.identifier || props.title || 'Polar Area Chart'
  ...
  return {
    label: `PolarAreaChart: ${displayLabel}`,
    children,
  }
}
</script>
