...
export const PROP_SCHEMA = {
  ...
  title: { type: 'string', default: 'Line Chart', control: 'text', label: 'Title' },
  ...
  fillArea: { type: 'boolean', default: false, control: 'switch', label: 'Fill Area Under Line' },
...
export function buildPropertySchema(props = {}) {
  const displayLabel = props.identifier || props.title || 'Line Chart'
