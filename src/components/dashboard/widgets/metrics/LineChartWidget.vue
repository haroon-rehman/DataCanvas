...
export const widgetMeta = {
  ...
  description: "Displays a line chart for time-series or categorical metrics.",
  icon: "fa-solid fa-chart-line",
  group: "Charts",
};

/** Full property metadata for LineChartWidget. */
export const PROP_SCHEMA = {
  ...
  labels: {
    ...
    description: "Labels for each data point, comma-separated.",
  },
  values: {
    type: "string",
    default: "10,20,30",
    ...
    description: "Numeric values for each data point, comma-separated.",
  },
  ...
  fillArea: {
    ...
    description: "Whether to fill the area under the line with a semi-transparent color.",
  },
  lineColor: {
    type: "string",
    default: "#0d6efd",
  ...
  backgroundFillColor: {
    type: "string",
    default: "rgba(13,110,253,0.1)",
    control: "colorPure",
    label: "Fill Color",
    description: "Color used to fill the area under the line when fill area is enabled.",
  },
  pointBackgroundColor: {
    ...
    control: "colorPure",
    label: "Point Color",
    description: "Background color of the data point markers.",
  },
  lineBorderWidth: {
    type: "number",
    default: 2,
  ...
  yBeginAtZero: {
    ...
    description: "Whether the Y axis scale starts at zero.",
  },
  fillCell: {
    type: "boolean",
    default: true,
...
const props = defineProps({
  ...
  fillArea: { type: [Boolean, String], default: false },
  lineColor: { type: String, default: "#0d6efd" },
  backgroundFillColor: { type: String, default: "rgba(13,110,253,0.1)" },
...
const titleStyle = computed(() => {
  ...
  // Horizontal text alignment for the title
  ...
  // Make alignment visible by stretching to full width
  s.width = "100%";
    ...
    datasets: [
      {
        ...
        data: dataValues,
        backgroundColor: asBool(props.fillArea, false)
          ? props.backgroundFillColor || "rgba(13,110,253,0.1)"
          : "transparent",
        ...
        fill: asBool(props.fillArea, false),
      },
    ],
  };
});
