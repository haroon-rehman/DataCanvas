      ...
      if (row.height.kind === "percent") {
        ...
        const normalizedPercent =
          totalPercent > 0 && totalPercent !== 100
            ...
            : percentValue;
        // Use vh so height doesn't depend on % of parent (avoids extra scrollbars).
        // Reserve 10rem for nav + editor chrome so the grid fits in the viewport.
        const vhReserve = "10rem";
